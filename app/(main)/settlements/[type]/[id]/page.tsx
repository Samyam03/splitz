  ...
  if (!settlementData) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-center items-center min-h-[300px]">
            <div className="text-center space-y-3 p-6 bg-white rounded-xl shadow-lg">
              ...
              <h3 className="text-lg font-bold text-gray-900">No Settlement Data</h3>
              <p className="text-gray-600">Settlement information is not available</p>
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className={`p-2 rounded-lg ${isUserSettlement 
                ? 'bg-blue-100' 
                : 'bg-purple-100'
              }`}>
                {isUserSettlement ? (
                  <User className={`w-5 h-5 ${isUserSettlement ? 'text-blue-600' : 'text-purple-600'}`} />
                ) : (
                  <Users className={`w-5 h-5 ${isUserSettlement ? 'text-blue-600' : 'text-purple-600'}`} />
                )}
              </div>
              <div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center gap-4 p-4 bg-white rounded-lg">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-gray-900">{settlementData.counterpart.name}</h3>
                      <p className="text-gray-600">{settlementData.counterpart.email}</p>
                    </div>
                  </div>
                    ...
                    <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <h4 className="font-semibold text-green-700">You are owed</h4>
                        </div>
                    ...
                    <div className="p-4 bg-white rounded-lg border border-gray-200">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <h4 className="font-semibold text-gray-700">Net Balance</h4>
                        </div>
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-br from-purple-50 to-violet-50 h-full">
                ...
                <CardContent className="space-y-4">
                  <div className="p-3 bg-white rounded-lg">
                    <h3 className="text-lg font-bold text-gray-900">{settlementData.group.name}</h3>
                    {settlementData.group.description && (
                      <p className="text-gray-600 text-sm">{settlementData.group.description}</p>
                    )}
                    ...
                    <div className="space-y-2 max-h-[300px] overflow-y-auto">
                      {settlementData.balances
                        ...
                        .map((balance: any) => {
                          ...
                          return (
                            <div key={balance.userId} className="flex items-center justify-between p-3 bg-white rounded-lg border">
                              <div className="flex items-center gap-3">
                                <Avatar className={`h-8 w-8 ring-1 ${userColor.ring}`}>
                                  <AvatarImage src={balance.imageUrl} />
                                  <AvatarFallback className={`${userColor.bg} ${userColor.text} text-sm font-semibold`}>
            ...
            <Card className="shadow-lg border-0 bg-gradient-to-br from-green-50 to-emerald-50 h-full">
              ...
              <CardContent>
                <form onSubmit={handleCreateSettlement} className="space-y-4">
                    ...
                    {isUserSettlement ? (
                      ...
                      >
                        <div className="text-left flex items-center gap-3 w-full">
                          ...
                          <div className="flex-1">
                            <div className="font-semibold">Pay {settlementData.counterpart.name}</div>
                            <div className="text-sm opacity-80">You send money to them</div>
                          </div>
                        </div>
                      </Button>
                    ) : (
                      <select
                        ...
                        className="w-full p-3 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-400 bg-white"
                        required
                      >
                  ...
                  {/* Amount Input */}
                  <div className="space-y-2">
                    <Label htmlFor="amount" className="text-sm font-semibold text-gray-800">Settlement Amount</Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder="0.00"
                        className="pl-10 h-12 text-lg font-semibold bg-white border-green-200 focus:ring-2 focus:ring-green-500 focus:border-green-400"
                        required
                      />
                    </div>
                  </div>
                  ...
                  {/* Note Input */}
                  <div className="space-y-2">
                    <Label htmlFor="note" className="text-sm font-semibold text-gray-800">Add a Note (Optional)</Label>
                    <Textarea
                      id="note"
                      value={note}
                      onChange={(e) => setNote(e.target.value)}
                      placeholder="Add details about this settlement..."
                      className="min-h-[100px] bg-white border-green-200 focus:ring-2 focus:ring-green-500 focus:border-green-400 resize-none"
                      maxLength={200}
                    />
