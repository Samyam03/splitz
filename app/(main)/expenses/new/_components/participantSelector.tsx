...
const ParticipantSelector = ({participants, onParticipantsChange}: {participants: any, onParticipantsChange: any}) => {
  ...
  return (
    <div className="space-y-4">
      <Label className="text-sm font-semibold text-gray-700">Participants</Label>
            ...
            return (
              <Badge
                ...
                className={`flex items-center gap-3 p-3 transition-all duration-200 ${
                  isCurrentUser 
                    ? "bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 border-blue-200 hover:from-blue-200 hover:to-indigo-200" 
