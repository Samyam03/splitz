...
const GroupBalances = ({balances}: {balances: any}) => {
    ...
    if (!balances?.length || !currentUser) {
        return (
            <div className="text-center py-8 space-y-3 flex flex-col justify-center h-full">
                ...
                <div>
                    <p className="text-gray-700 font-semibold text-sm">No balance information</p>
    ...
    if (!myBalance) {
        return (
            <div className="text-center py-8 space-y-3 flex flex-col justify-center h-full">
                <div className="w-12 h-12 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex items-center justify-center mx-auto shadow-lg">
                    <ArrowDown className="w-5 h-5 text-white" />
                </div>
                <div>
                    <p className="text-gray-700 font-semibold text-sm">Not a group member</p>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className={`p-6 rounded-xl border-2 shadow-lg transition-all duration-300 ${
                ...
                <div className="text-center space-y-3">
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <h3 className="text-sm font-semibold text-gray-700">Your Balance</h3>
                    </div>
           ...
           {isAllSettledUp ? (
            <div className="text-center py-8 space-y-3 flex flex-col justify-center">
                ...
                <div>
                    <p className="text-green-700 font-semibold text-sm">All settled up!</p>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-green-50/80 to-emerald-50/80 rounded-xl border border-green-200/50 p-6 shadow-lg">
                <div className="flex items-center gap-3 text-sm font-semibold text-green-700 pb-4 border-b border-green-200/60">
                  <div className="p-2 bg-gradient-to-br from-green-400 to-emerald-500 rounded-lg shadow-sm">
                    <ArrowUp className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-base">You are owed</span>
                  <div className="ml-auto bg-green-100 text-green-700 text-xs font-medium px-3 py-1.5 rounded-full shadow-sm">
                ...
                <div className="space-y-3 mt-4">
                  {owedByMembers.map((item:any)=>{
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between p-4 bg-white/70 hover:bg-white rounded-xl border border-green-200/30 hover:border-green-300/50 transition-all duration-300 hover:shadow-md group-hover:scale-[1.02]">
              ...
              {owedToMembers && owedToMembers.length>0 &&
               <div className="bg-gradient-to-br from-red-50/80 to-rose-50/80 rounded-xl border border-red-200/50 p-6 shadow-lg">
               <div className="flex items-center gap-3 text-sm font-semibold text-red-700 pb-4 border-b border-red-200/60">
                 <div className="p-2 bg-gradient-to-br from-red-400 to-rose-500 rounded-lg shadow-sm">
                   <ArrowDown className="w-4 h-4 text-white" />
                 </div>
                 <span className="text-base">You owe</span>
                 <div className="ml-auto bg-red-100 text-red-700 text-xs font-medium px-3 py-1.5 rounded-full shadow-sm">
                 ...
                 {owedToMembers.map((item:any)=>{
                   ...
                   return (
                     <Link 
                       ...
                       className="block group"
                     >
                       <div className="flex items-center justify-between p-4 bg-white/70 hover:bg-white rounded-xl border border-red-200/30 hover:border-red-300/50 transition-all duration-300 hover:shadow-md group-hover:scale-[1.02]">
                         <div className="flex items-center gap-3">
                           <Avatar className={`h-7 w-7 ring-2 ${userColor.ring} shadow-sm`}>
                             <AvatarImage src={item.imageUrl} />
                             <AvatarFallback className={`${userColor.bg} ${userColor.text} font-semibold text-xs`}>
